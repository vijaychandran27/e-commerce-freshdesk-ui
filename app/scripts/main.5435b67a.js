...
/* harmony import */ var _components_ProductDetails__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/ProductDetails */ 759);
...
var App = function App() {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    ...
    element: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_ProductDetails__WEBPACK_IMPORTED_MODULE_5__["default"], null),
    exact: true
  }))));
};
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            try {
              response = (0,_helper_apiHelper__WEBPACK_IMPORTED_MODULE_1__.postCall)('/login', {
                username: username,
                password: password
              });
              if (response !== null && response !== void 0 && (_response$data = response.data) !== null && _response$data !== void 0 && (_response$data = _response$data.data) !== null && _response$data !== void 0 && _response$data.token) {
                localStorage.setItem('token', response === null || response === void 0 || (_response$data2 = response.data) === null || _response$data2 === void 0 || (_response$data2 = _response$data2.data) === null || _response$data2 === void 0 ? void 0 : _response$data2.token);
                replaceUrl();
              } else {
...
var ProductDetails = function ProductDetails() {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    if (!token) {
      ...
      var _product = products === null || products === void 0 ? void 0 : products.find(function (x) {
        return x.id === productId;
      });
      setProduct(_product);
    }
  }, [products, token]);
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h2", null, "Product Details"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, "Name: ", product.name), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, "Description: ", product.description), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, "Price: $", product.price.toFixed(2)));
};
...
var ProductList = function ProductList() {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    if (!token) {
      ...
      var _response$data;
      var response = (0,_helper_apiHelper__WEBPACK_IMPORTED_MODULE_1__.getCall)('/products');
      if (response !== null && response !== void 0 && (_response$data = response.data) !== null && _response$data !== void 0 && _response$data.data) {
        ...
        localStorage.setItem('products', response === null || response === void 0 || (_response$data2 = response.data) === null || _response$data2 === void 0 ? void 0 : _response$data2.data);
        setProducts(_toConsumableArray(response === null || response === void 0 || (_response$data3 = response.data) === null || _response$data3 === void 0 ? void 0 : _response$data3.data));
...
/* harmony export */   "postCall": () => (/* binding */ postCall)
/* harmony export */ });
...
//# sourceMappingURL=main.5435b67a.js.map